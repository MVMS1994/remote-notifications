      ...
      return (
        <Nav>
          <NavDropdown
            ...
            <NavDropdown.Divider />
            <NavDropdown.Item eventKey="EXPORT_DB" onSelect={this.props.onOptionsSelect}> Export </NavDropdown.Item>
            <NavDropdown.Item eventKey="IMPORT_DB" onSelect={this.props.onOptionsSelect}> Import </NavDropdown.Item>
            <NavDropdown.Divider />
            <NavDropdown.Item>
              <Button
                style={{
